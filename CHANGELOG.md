...
- **Test harness** — Textual SVG golden snapshots backed by Syrupy across themes, a full slash-command + key-binding coverage matrix, and an import-guard test asserting the frontend never imports `agent_utilities`/`torch`.
